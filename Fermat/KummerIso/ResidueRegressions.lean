...
import Fermat.SixHundredSeven.GenericSecondCase
...
fields replace the temporary `BernoulliValidationBound` seam. Consequently,
the only project axiom in these FLT endpoints is termination of the generic
Sophie--Germain search used for Case I.
-/
...
theorem holdsAt_thirtySeven : Fermat.HoldsAt 37 :=
  holdsAt_of_residueCertificate_canonical_of_fixedCertificate
...
theorem holdsAt_oneHundredFiftySeven : Fermat.HoldsAt 157 :=
  holdsAt_of_residueCertificate_canonical_of_fixedCertificate
    ...
    (fun hζ ↦
      Fermat.OneHundredFiftySeven.GenericSecondCase.fixedSecondCaseCertificate157 hζ)
...
theorem holdsAt_fourHundredNinetyOne : Fermat.HoldsAt 491 :=
  holdsAt_of_residueCertificate_canonical_of_fixedCertificate
    ...
    (fun hζ ↦
      Fermat.FourHundredNinetyOne.GenericSecondCase.fixedSecondCaseCertificate491 hζ)
...
theorem holdsAt_fiveHundredEightySeven : Fermat.HoldsAt 587 :=
  holdsAt_of_residueCertificate_canonical_of_fixedCertificate
    ...
    (fun hζ ↦
      Fermat.FiveHundredEightySeven.GenericSecondCase.fixedSecondCaseCertificate587 hζ)
...
theorem holdsAt_sixHundredSeven : Fermat.HoldsAt 607 :=
  holdsAt_of_residueCertificate_canonical_of_fixedCertificate
    ...
    (fun hζ ↦
      Fermat.SixHundredSeven.GenericSecondCase.fixedSecondCaseCertificate607 hζ)
...
theorem holdsAt_sixHundredNinetyOne : Fermat.HoldsAt 691 :=
  holdsAt_of_residueCertificate_canonical_of_fixedCertificate
    ...
    (fun hζ ↦
      Fermat.SixHundredNinetyOne.GenericSecondCase.fixedSecondCaseCertificate691 hζ)
...
theorem holdsAt_oneThousandThreeHundredEightyOne :
  ...
  holdsAt_of_residueCertificate_canonical_of_fixedCertificate
    ...
    (fun hζ ↦
      Fermat.OneThousandThreeHundredEightyOne.GenericSecondCase.fixedSecondCaseCertificate1381 hζ)
