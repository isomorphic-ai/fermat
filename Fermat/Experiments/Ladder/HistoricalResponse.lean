import Fermat.Experiments.Ladder.FiftyNine
import Fermat.Experiments.Ladder.FiveHundredEightySeven
import Fermat.Experiments.Ladder.FourHundredNinetyOne
import Fermat.Experiments.Ladder.OneHundredFiftySeven
import Fermat.Experiments.Ladder.SixHundredNinetyOne
import Fermat.Experiments.Ladder.SixtySeven
import Fermat.Experiments.Ladder.ThirtySeven
...
def fourHundredNinetyOne : Point :=
  mkPoint FourHundredNinetyOne.proofBacked
    FourHundredNinetyOne.exitDepth
    FourHundredNinetyOne.exitDepth_eq_measured
