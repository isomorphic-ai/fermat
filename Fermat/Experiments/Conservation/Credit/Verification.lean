...
import Fermat.Experiments.Conservation.Credit.LogRateFlow
import Fermat.Experiments.Conservation.Credit.HighFlowClosure
import Fermat.Experiments.Conservation.Credit.CompletedFlow
import Fermat.Experiments.Conservation.Credit.Bernoulli
import Fermat.Experiments.Conservation.Credit.Gauge
import Fermat.Experiments.Conservation.Credit.HighFlow
import Fermat.Experiments.Conservation.Credit.Forcing
import Fermat.Experiments.Conservation.Credit.DepthFlow
import Fermat.Experiments.Conservation.Credit.CyclotomicFlow
import Fermat.Experiments.Conservation.Credit.MomentFlow
import Fermat.Experiments.Conservation.Credit.NonlinearFlow
import Fermat.Experiments.Conservation.Credit.RationalReduction
import Fermat.Experiments.Conservation.Credit.RealGauge
import Fermat.Experiments.Conservation.Credit.RealHighFlow
...
import Fermat.Experiments.Conservation.Credit.GaugeQuotient
...
elab "#guard_no_selected_prime_literal" : command => do
  ...
  for filename in
      #["CyclotomicDrain.lean", "KummerDrain.lean", "Transfer.lean",
        ...
        "PowerRootObstruction.lean", "PowerRootExactSequence.lean",
