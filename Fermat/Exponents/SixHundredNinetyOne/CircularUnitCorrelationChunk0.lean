import Fermat.Exponents.SixHundredNinetyOne.CircularUnitMatrix

/-!
# Cyclic-correlation data at exponent 691: residues 0--34
...
theorem phase_correlation_chunk0 (d : Cyc) (hd : d.val < 35) :
