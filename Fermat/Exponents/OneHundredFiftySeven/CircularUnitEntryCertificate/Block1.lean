import Fermat.Exponents.OneHundredFiftySeven.CircularUnitEntryCertificate.Block0

/-! # Rows 7--13 of the exponent-157 circular-unit entry certificate -/
...
theorem entryBlock1 (row : Fin 7) (i : Fin 77) :
