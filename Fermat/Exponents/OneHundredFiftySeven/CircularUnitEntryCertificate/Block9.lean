import Fermat.Exponents.OneHundredFiftySeven.CircularUnitEntryCertificate.Block8

/-! # Rows 63--69 of the exponent-157 circular-unit entry certificate -/
...
theorem entryBlock9 (row : Fin 7) (i : Fin 77) :
