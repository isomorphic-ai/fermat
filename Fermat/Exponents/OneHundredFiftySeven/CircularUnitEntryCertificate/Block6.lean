import Fermat.Exponents.OneHundredFiftySeven.CircularUnitEntryCertificate.Block5

/-! # Rows 42--48 of the exponent-157 circular-unit entry certificate -/
...
theorem entryBlock6 (row : Fin 7) (i : Fin 77) :
