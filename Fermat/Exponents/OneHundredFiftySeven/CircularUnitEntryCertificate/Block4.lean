import Fermat.Exponents.OneHundredFiftySeven.CircularUnitEntryCertificate.Block3

/-! # Rows 28--34 of the exponent-157 circular-unit entry certificate -/
...
theorem entryBlock4 (row : Fin 7) (i : Fin 77) :
