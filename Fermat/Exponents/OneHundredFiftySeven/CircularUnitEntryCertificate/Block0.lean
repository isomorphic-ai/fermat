import Fermat.Exponents.OneHundredFiftySeven.CircularUnitEntryCertificate.Basic

/-! # Rows 0--6 of the exponent-157 circular-unit entry certificate -/
...
theorem entryBlock0 (row : Fin 7) (i : Fin 77) :
