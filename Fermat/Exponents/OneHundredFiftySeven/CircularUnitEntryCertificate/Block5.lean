import Fermat.Exponents.OneHundredFiftySeven.CircularUnitEntryCertificate.Block4

/-! # Rows 35--41 of the exponent-157 circular-unit entry certificate -/
...
theorem entryBlock5 (row : Fin 7) (i : Fin 77) :
