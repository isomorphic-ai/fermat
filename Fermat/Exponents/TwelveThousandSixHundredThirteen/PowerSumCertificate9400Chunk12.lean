...
/-!
# Lifted power-sum block 12 for the j=9400 channel
...
/-- The `[12288, 12613)` block for the lifted `j = 9400` power sum. -/
theorem partialPowerSum_118562200_12288_12613 :
    partialPowerSum 118562200 12288 12613 = 9736769384457140 := by
