...
/-!
# Lifted power-sum block 5 for the j=9400 channel
...
/-- The `[5120, 6144)` block for the lifted `j = 9400` power sum. -/
theorem partialPowerSum_118562200_5120_6144 :
    partialPowerSum 118562200 5120 6144 = 3753888229723840 := by
