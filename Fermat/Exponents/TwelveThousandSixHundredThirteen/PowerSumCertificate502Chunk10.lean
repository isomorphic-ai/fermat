...
/-!
# Lifted power-sum block 10 for the j=502 channel
...
/-- The `[10240, 11264)` block for the lifted `j = 502` power sum. -/
theorem partialPowerSum_6331726_10240_11264 :
    partialPowerSum 6331726 10240 11264 = 18608014227805837 := by
