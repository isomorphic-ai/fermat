...
/-!
# Lifted power-sum block 7 at exponent 12613
...
It is leaf 7 in the bounded-memory partition of
...
/-- The `[7168, 8192)` block for the lifted `j = 308` power sum, modulo
`12613 ^ 4 = 25308918245397361`. -/
theorem partialPowerSum_3884804_7168_8192 :
    partialPowerSum 3884804 7168 8192 = 23194804276750308 := by
