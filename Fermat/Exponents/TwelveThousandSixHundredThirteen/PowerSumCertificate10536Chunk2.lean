...
/-!
# Lifted power-sum block 2 for the j=10536 channel
...
/-- The `[2048, 3072)` block for the lifted `j = 10536` power sum. -/
theorem partialPowerSum_132890568_2048_3072 :
    partialPowerSum 132890568 2048 3072 = 19865793689446855 := by
