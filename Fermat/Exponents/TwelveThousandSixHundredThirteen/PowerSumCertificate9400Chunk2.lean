...
/-!
# Lifted power-sum block 2 for the j=9400 channel
...
/-- The `[2048, 3072)` block for the lifted `j = 9400` power sum. -/
theorem partialPowerSum_118562200_2048_3072 :
    partialPowerSum 118562200 2048 3072 = 10746226712476167 := by
