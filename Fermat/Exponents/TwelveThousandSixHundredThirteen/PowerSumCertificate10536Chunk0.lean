...
/-!
# Lifted power-sum block 0 for the j=10536 channel
...
/-- The `[0, 1024)` block for the lifted `j = 10536` power sum. -/
theorem partialPowerSum_132890568_zero_1024 :
    partialPowerSum 132890568 0 1024 = 7287331303245525 := by
