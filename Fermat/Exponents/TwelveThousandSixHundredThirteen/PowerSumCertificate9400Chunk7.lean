...
/-!
# Lifted power-sum block 7 for the j=9400 channel
...
/-- The `[7168, 8192)` block for the lifted `j = 9400` power sum. -/
theorem partialPowerSum_118562200_7168_8192 :
    partialPowerSum 118562200 7168 8192 = 20828391396630326 := by
