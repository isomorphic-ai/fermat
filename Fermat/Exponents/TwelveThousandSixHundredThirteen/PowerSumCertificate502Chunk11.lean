...
/-!
# Lifted power-sum block 11 for the j=502 channel
...
/-- The `[11264, 12288)` block for the lifted `j = 502` power sum. -/
theorem partialPowerSum_6331726_11264_12288 :
    partialPowerSum 6331726 11264 12288 = 19326122823143071 := by
