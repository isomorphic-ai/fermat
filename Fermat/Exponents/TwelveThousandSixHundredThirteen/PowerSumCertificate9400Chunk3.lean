...
/-!
# Lifted power-sum block 3 for the j=9400 channel
...
/-- The `[3072, 4096)` block for the lifted `j = 9400` power sum. -/
theorem partialPowerSum_118562200_3072_4096 :
    partialPowerSum 118562200 3072 4096 = 17626071072722961 := by
