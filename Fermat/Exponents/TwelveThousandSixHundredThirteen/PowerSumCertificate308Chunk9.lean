...
/-!
# Lifted power-sum block 9 at exponent 12613
...
It is leaf 9 in the bounded-memory partition of
...
/-- The `[9216, 10240)` block for the lifted `j = 308` power sum, modulo
`12613 ^ 4 = 25308918245397361`. -/
theorem partialPowerSum_3884804_9216_10240 :
    partialPowerSum 3884804 9216 10240 = 23539586146628177 := by
