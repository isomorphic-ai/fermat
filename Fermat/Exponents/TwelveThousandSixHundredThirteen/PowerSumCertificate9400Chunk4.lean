...
/-!
# Lifted power-sum block 4 for the j=9400 channel
...
/-- The `[4096, 5120)` block for the lifted `j = 9400` power sum. -/
theorem partialPowerSum_118562200_4096_5120 :
    partialPowerSum 118562200 4096 5120 = 16747817024480017 := by
