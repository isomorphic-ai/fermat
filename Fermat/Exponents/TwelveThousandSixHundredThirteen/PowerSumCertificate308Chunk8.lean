...
/-!
# Lifted power-sum block 8 at exponent 12613
...
It is leaf 8 in the bounded-memory partition of
...
/-- The `[8192, 9216)` block for the lifted `j = 308` power sum, modulo
`12613 ^ 4 = 25308918245397361`. -/
theorem partialPowerSum_3884804_8192_9216 :
    partialPowerSum 3884804 8192 9216 = 12374393809856766 := by
