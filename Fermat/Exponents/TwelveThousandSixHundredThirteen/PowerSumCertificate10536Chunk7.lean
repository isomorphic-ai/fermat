...
/-!
# Lifted power-sum block 7 for the j=10536 channel
...
/-- The `[7168, 8192)` block for the lifted `j = 10536` power sum. -/
theorem partialPowerSum_132890568_7168_8192 :
    partialPowerSum 132890568 7168 8192 = 15608771722853980 := by
