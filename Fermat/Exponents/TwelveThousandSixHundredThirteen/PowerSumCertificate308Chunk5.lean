...
/-!
# Lifted power-sum block 5 at exponent 12613

This certificate covers the half-open interval `[5120, 6144)` in the
`j = 308` channel, whose lifted exponent is `308 * 12613 = 3884804`.
The modulus is `12613 ^ 4 = 25308918245397361`.

It is leaf 5 in the bounded-memory partition of
...
/-- The `[5120, 6144)` block for the lifted `j = 308` power sum, modulo
`12613 ^ 4 = 25308918245397361`. -/
theorem partialPowerSum_3884804_5120_6144 :
    partialPowerSum 3884804 5120 6144 = 16333703108588667 := by
