...
/-!
# Lifted power-sum block 8 for the j=10536 channel
...
/-- The `[8192, 9216)` block for the lifted `j = 10536` power sum. -/
theorem partialPowerSum_132890568_8192_9216 :
    partialPowerSum 132890568 8192 9216 = 7525135149590342 := by
