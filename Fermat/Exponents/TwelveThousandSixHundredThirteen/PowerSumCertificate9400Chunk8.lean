...
/-!
# Lifted power-sum block 8 for the j=9400 channel
...
/-- The `[8192, 9216)` block for the lifted `j = 9400` power sum. -/
theorem partialPowerSum_118562200_8192_9216 :
    partialPowerSum 118562200 8192 9216 = 4840697217974585 := by
