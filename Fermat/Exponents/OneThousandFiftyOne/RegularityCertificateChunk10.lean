import Fermat.Exponents.OneThousandFiftyOne.RegularityCertificateChunk9
...
theorem scanResidue_ne_zero_chunk10
    (i : Fin 24) :
    scanResidue 1051 7
      (scanIndex (offsetIndex 500 24 (by omega) i)) ≠ 0 := by
  decide +revert
