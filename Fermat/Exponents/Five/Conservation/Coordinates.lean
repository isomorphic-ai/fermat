import Fermat.Exponents.Five.Conservation.Equation
import Fermat.Exponents.Five.Conservation.InitialArithmetic
...
Dirichlet coordinate formalization in `Fermat/Five/Coordinates.lean`.  This
