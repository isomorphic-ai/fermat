import Fermat.Exponents.Five.Conservation.Modular
...
Dirichlet equation formalization in `Fermat/Five/Equation.lean`.  This module
does not import that file or cite any declaration from the earlier
exponent-five route.
