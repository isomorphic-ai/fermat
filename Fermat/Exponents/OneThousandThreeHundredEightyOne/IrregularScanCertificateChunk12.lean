import Fermat.Exponents.OneThousandThreeHundredEightyOne.IrregularScanCertificateChunk11
...
theorem scanResidue_zero_only_at_channel_chunk12
    (i : Fin 50) :
    scanResidue 1381 2 (scanIndex (offsetIndex 600 50 (by omega) i)) = 0 →
      scanIndex (offsetIndex 600 50 (by omega) i) = 266 := by
  decide +revert
