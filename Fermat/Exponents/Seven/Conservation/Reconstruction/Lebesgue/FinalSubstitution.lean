import Fermat.Exponents.Seven.Conservation.Reconstruction.Lebesgue.Descent
import Fermat.Exponents.Seven.Conservation.Reconstruction.Lebesgue.EvenSquare
import Fermat.Exponents.Seven.Conservation.Reconstruction.Lebesgue.Symmetric

/-
Reconstruction provenance: adapted with credit from the repository's earlier
Lebesgue formalization in `Fermat/Seven/Lebesgue/FinalSubstitution.lean`.  This
module does not import or call any declaration from that earlier exponent-seven
route.
-/
