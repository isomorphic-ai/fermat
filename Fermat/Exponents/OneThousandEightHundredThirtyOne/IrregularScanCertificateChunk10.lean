import Fermat.Exponents.OneThousandEightHundredThirtyOne.IrregularScanCertificateChunk9
...
theorem scanResidue_zero_only_at_channel_chunk10
    (i : Fin 50) :
    scanResidue 1831 3 (scanIndex (offsetIndex 500 50 (by omega) i)) = 0 →
      scanIndex (offsetIndex 500 50 (by omega) i) = 1274 := by
  decide +revert
