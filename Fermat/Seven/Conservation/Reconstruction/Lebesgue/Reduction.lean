...
outer reduction in `Fermat/Seven/Lebesgue/Reduction.lean`.  This module imports
only the proposition-level FLT boundary and does not import or call any
declaration from the earlier exponent-seven route.
-/
