...
/-!
# Lifted power-sum block 4 for the j=502 channel
...
/-- The `[4096, 5120)` block for the lifted `j = 502` power sum. -/
theorem partialPowerSum_6331726_4096_5120 :
    partialPowerSum 6331726 4096 5120 = 5080949844956136 := by
