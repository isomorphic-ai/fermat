...
/-!
# Lifted power-sum block 1 for the j=10536 channel
...
/-- The `[1024, 2048)` block for the lifted `j = 10536` power sum. -/
theorem partialPowerSum_132890568_1024_2048 :
    partialPowerSum 132890568 1024 2048 = 6358871027728394 := by
