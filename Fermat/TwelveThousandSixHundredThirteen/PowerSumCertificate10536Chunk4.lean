...
/-!
# Lifted power-sum block 4 for the j=10536 channel
...
/-- The `[4096, 5120)` block for the lifted `j = 10536` power sum. -/
theorem partialPowerSum_132890568_4096_5120 :
    partialPowerSum 132890568 4096 5120 = 10352795687497183 := by
