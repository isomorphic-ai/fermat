...
/-!
# Lifted power-sum block 5 for the j=502 channel
...
/-- The `[5120, 6144)` block for the lifted `j = 502` power sum. -/
theorem partialPowerSum_6331726_5120_6144 :
    partialPowerSum 6331726 5120 6144 = 3972307875822734 := by
