...
/-!
# Lifted power-sum block 3 at exponent 12613
...
It is leaf 3 in the bounded-memory partition of
...
/-- The `[3072, 4096)` block for the lifted `j = 308` power sum, modulo
`12613 ^ 4 = 25308918245397361`. -/
theorem partialPowerSum_3884804_3072_4096 :
    partialPowerSum 3884804 3072 4096 = 21399186688250987 := by
