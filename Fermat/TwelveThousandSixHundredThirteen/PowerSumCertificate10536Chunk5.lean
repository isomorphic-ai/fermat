...
/-!
# Lifted power-sum block 5 for the j=10536 channel
...
/-- The `[5120, 6144)` block for the lifted `j = 10536` power sum. -/
theorem partialPowerSum_132890568_5120_6144 :
    partialPowerSum 132890568 5120 6144 = 15179399731151705 := by
