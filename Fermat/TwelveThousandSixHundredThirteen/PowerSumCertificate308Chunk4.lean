...
/-!
# Lifted power-sum block 4 at exponent 12613

This certificate covers the half-open interval `[4096, 5120)` in the
`j = 308` channel, whose lifted exponent is `308 * 12613 = 3884804`.
The modulus is `12613 ^ 4 = 25308918245397361`.

It is leaf 4 in the bounded-memory partition of
...
/-- The `[4096, 5120)` block for the lifted `j = 308` power sum, modulo
`12613 ^ 4 = 25308918245397361`. -/
theorem partialPowerSum_3884804_4096_5120 :
    partialPowerSum 3884804 4096 5120 = 6480302604369092 := by
