...
/-!
# Lifted power-sum block 9 for the j=10536 channel
...
/-- The `[9216, 10240)` block for the lifted `j = 10536` power sum. -/
theorem partialPowerSum_132890568_9216_10240 :
    partialPowerSum 132890568 9216 10240 = 24490003720611918 := by
