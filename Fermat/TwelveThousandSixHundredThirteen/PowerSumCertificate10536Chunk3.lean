...
/-!
# Lifted power-sum block 3 for the j=10536 channel
...
/-- The `[3072, 4096)` block for the lifted `j = 10536` power sum. -/
theorem partialPowerSum_132890568_3072_4096 :
    partialPowerSum 132890568 3072 4096 = 5671105520205170 := by
