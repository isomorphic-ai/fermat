...
/-!
# Lifted power-sum block 6 for the j=9400 channel
...
/-- The `[6144, 7168)` block for the lifted `j = 9400` power sum. -/
theorem partialPowerSum_118562200_6144_7168 :
    partialPowerSum 118562200 6144 7168 = 20826160811346584 := by
