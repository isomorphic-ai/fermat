...
diagonal-unit, derivative, and two-channel axis-8 data are packaged as a
...
proof-producing Sophie--Germain search to obtain `Fermat.HoldsAt 157`.
...
/-- The fixed-second-case certificate at `157`.
